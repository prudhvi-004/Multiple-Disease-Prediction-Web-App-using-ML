...
with open(heart_path,'rb') as b:
    heart_model = pickle.load(b)
with open(parkison_path,'rb') as c:
    parkison_model = pickle.load(c)
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        try:
            ...
            parkinsons_prediction = parkison_model.predict([input_data])
